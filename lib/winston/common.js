...
exports.clone = function (obj) {
  if (obj instanceof Error || obj.meta instanceof Error) {
    ...
    if (obj instanceof Error) {
      ...
      // added to fix a problem of logging Empty Error object
      var firstResult = clone(cycle.decycle(obj));
      var copy2 = { message: obj.meta.message }; //TODO: fix \n character problem.

      Object.getOwnPropertyNames(obj.meta).forEach(function (key) {
        copy2[key] = obj.meta[key];
      });

      firstResult.meta = copy2;
      return firstResult;
    }
